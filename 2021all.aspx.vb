...
Public Class _2021all
    Inherits System.Web.UI.Page
    Public saleseasonid As Integer = 15
    ...
    Private Sub BindGrid(ByVal searchterm As String)
        ...
        If searchterm = "0" Then
            sqlstring = "SELECT * FROM vw_2021_all WHERE saleseasonID = " & saleseasonid & " ORDER BY ticketid;"

        Else
            sqlstring = "SELECT * FROM vw_2021_all WHERE (SaleID = '" & searchterm & "' OR ticketid = '" & searchterm & "' OR ticketname like '%" & searchterm & "%' OR ticketemail like '%" & searchterm & "%' OR ticketpostcode like '%" & searchterm & "%') AND saleseasonID = " & saleseasonid & " ORDER BY ticketid;"
        End If
        ...
        Else
            sqlstring = "Select * FROM vw_2021_all WHERE (SaleID = '" & searchterm & "' OR ticketname like '%" & searchterm & "%') AND saleseasonID = " & saleseasonid & " ORDER BY ticketid;"
        End If
    ...
    Protected Sub OnRowUpdating(ByVal sender As Object, ByVal e As GridViewUpdateEventArgs)
        ...
        SQLstr = "Update alltickets2021 SET "
    ...
    Protected Sub Insert(ByVal sender As Object, ByVal e As EventArgs)
        ...
        SQLstr = "INSERT INTO alltickets2021 SET "
        SQLstr &= "saleseasonID = " & saleseasonid
        SQLstr &= ", "
        SQLstr &= "terraceid = " & terraceid
        SQLstr &= ", "
