                ...
                Using sda As New MySqlDataAdapter()
                    ...
                    Using tableE As New DataTable()
                        ...
                        Using con2 As New MySqlConnection(constr2)
                            Using cmd2 As New MySqlCommand("SELECT *  FROM vw_seat_status_15 WHERE saleid IN (SELECT MAX(saleid) FROM vw_seat_status_15 GROUP BY standid, seatrow,seatnumber) AND StandID= " & standid & ";")
