<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="2021all.aspx.vb" Inherits="admintickets._2021all" %>
       ...
       <div class="col-3">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" 
            ...
            ErrorMessage="Address Cannot Be Empty" ControlToValidate="txtaddress" />
             ...
             <asp:ListItem Text="Complimentary" Value="8"></asp:ListItem>
             <asp:ListItem Text="Executive" Value="11"></asp:ListItem>
                            <asp:ListItem Text="Stream" Value="17"></asp:ListItem>
         </asp:DropDownList>
