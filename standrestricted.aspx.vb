...
Public Class standrestricted

    Inherits System.Web.UI.Page


    'using newstnad variable but is old stand
    Dim NewStandSeats As Int16 = 96
    Dim newStandSeatsSection1 As Int16 = 25
    Dim newStandSeatsSection2 As Int16 = 48
    Dim newStandSeatsSection3 As Int16 = 70
    Dim newStandSeatsSection4 As Int16 = 96
    'Dim newStandSeatsSection5 As Int16 = 96
    ...
    Dim newStandRows As Int16 = 17
    Dim newStandRowsString As String = "QPONMLKJIHGFEDCBA"
    Dim numbersections As Int16 = 4
    Public currentseason As String
    Dim standid As Int16 = 4
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ElseIf currentseason = "2360" Then
            fixturetitle.InnerText = "MAIN STAND : QUEENS PARK - SATURDAY 10TH JULY"
        ElseIf currentseason = "2368" Then
            fixturetitle.InnerText = "MAIN STAND :KILMARNOCK - SATURDAY 7TH AUG"
        End If
